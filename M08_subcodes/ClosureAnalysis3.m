...
%% filtering the curve
    ...
    fs = 1000; % Sampling frequency (assumed, adjust as appropriate)
...
%% Leakoff asymptote calculation at late time
    ...
    for i22=52:1:numel(common_time)-50
        ...
        p1 = polyfit(t_r(end-50:end),w_r(end-50:end),1);
