function  t_tsqrt_G_P_w = ClosureAnalysis4(t_P_org,t_w_org,t_reccession,w_reccesion)
...
%% filtering the curve
    ...
    fs = 2000; % Sampling frequency (assumed, adjust as appropriate)
